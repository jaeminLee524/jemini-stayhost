...
| Threshold | 기준 | 실측값 | 판정 |
|-----------|------|--------|------|
| search_duration p(95) | < 300ms (0.3s) | 3.37ms (0.003s) | PASS |
| search_duration p(99) | < 500ms (0.5s) | 9.97ms (0.010s) | PASS |
| detail_duration p(95) | < 300ms (0.3s) | 3.64ms (0.004s) | PASS |
| detail_duration p(99) | < 500ms (0.5s) | 10.42ms (0.010s) | PASS |
| rate_duration p(95) | < 500ms (0.5s) | 9.61ms (0.010s) | PASS |
| rate_duration p(99) | < 1000ms (1.0s) | 26.03ms (0.026s) | PASS |
| reservation_duration p(95) | < 1000ms (1.0s) | 7.55ms (0.008s) | PASS |
| reservation_duration p(99) | < 2000ms (2.0s) | 26.81ms (0.027s) | PASS |
...
|---------|-----|-----|-------|-------|-------|-------|-----|
| 검색 (search) | 1.39ms (0.001s) | 0.25ms | 0.66ms (0.001s) | 2.31ms (0.002s) | 3.37ms (0.003s) | 9.97ms (0.010s) | 201.98ms (0.202s) |
| 상세 (detail) | 1.55ms (0.002s) | 0.30ms | 0.71ms (0.001s) | 2.45ms (0.002s) | 3.64ms (0.004s) | 10.42ms (0.010s) | 201.59ms (0.202s) |
| 요금 (rate) | 4.60ms (0.005s) | 1.68ms (0.002s) | 2.87ms (0.003s) | 7.55ms (0.008s) | 9.61ms (0.010s) | 26.03ms (0.026s) | 204.36ms (0.204s) |
| 예약 (reservation) | 3.94ms (0.004s) | 1.00ms (0.001s) | 2.15ms (0.002s) | 6.04ms (0.006s) | 7.55ms (0.008s) | 26.81ms (0.027s) | 1000.00ms (1.000s) |
...
|---------|------|-------------|--------------|--------|
| 검색 | p(95) | 4.80ms (0.005s) | 3.37ms (0.003s) | -30% |
| 검색 | p(99) | 109.77ms (0.110s) | 9.97ms (0.010s) | -91% |
| 상세 | p(95) | 4.62ms (0.005s) | 3.64ms (0.004s) | -21% |
| 상세 | p(99) | 119.83ms (0.120s) | 10.42ms (0.010s) | -91% |
| 요금 | p(95) | 8.20ms (0.008s) | 9.61ms (0.010s) | +17% |
| 요금 | p(99) | 172.17ms (0.172s) | 26.03ms (0.026s) | -85% |
| 예약 | p(95) | 22.17ms (0.022s) | 7.55ms (0.008s) | -66% |
| 예약 | p(99) | 188.21ms (0.188s) | 26.81ms (0.027s) | -86% |
...
- 검색 p(50) 0.66ms (0.001s): 캐시 히트 시 sub-millisecond 응답
- 상세 조회 p(50) 0.71ms (0.001s): property + roomTypes 캐시 활용
- 요금 조회 p(50) 2.87ms (0.003s): Bulk IN 쿼리 1회 + warm-up 캐시 적재
- 예약 p(50) 2.15ms (0.002s): 캐시 미사용(쓰기 트랜잭션), 재고 비관적 잠금 포함
